            ...
            if self.perception.center_locations["red"][0] != 0 and self.perception.center_locations["green"][0] != 0 and self.perception.center_locations["blue"][0] != 0:
                ...
                for color in self.perception.target_color:
                    ...
                    if world_X:
                        ...
                        self.AK.setPitchRangeMoving((world_X, world_Y, 10), -90, -90, 0, 500)
                        time.sleep(0.35)
                        
                        self.AK.setPitchRangeMoving((world_X, world_Y, 15), -90, -90, 0, 500)
                        time.sleep(0.35)

                        Board.setBusServoPulse(2, 10, 200)
                        #self.AK.setPitchRangeMoving((world_X, world_Y, 12), -90, -90, 0, 500)
                        self.AK.setPitchRangeMoving((world_X, world_Y, 10), -90, -90, 0, 500)  #机械臂抬起 = the robotic arm is raised
                        time.sleep(0.35)
